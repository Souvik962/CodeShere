        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link className="p-2 text-gray-400 hover:text-gray-500 dark:hover:text-gray-300 transition-colors" to="/admin/users" title='All Users'>
                <User className="w-5 h-5" />
              </Link>
              <Link className="p-2 text-gray-400 hover:text-gray-500 dark:hover:text-gray-300 transition-colors" to="/send-notifications" title='send notification'>
                <BellPlus className="w-5 h-5" />
              </Link>
              <Link className="p-2 text-gray-400 hover:text-gray-500 dark:hover:text-gray-300 transition-colors" to="/admin/posts" title='Post setting'>
                <MessageSquareMore className="w-5 h-5" />
              </Link>
              <Link className="p-2 text-gray-400 hover:text-gray-500 dark:hover:text-gray-300 transition-colors" to="/admin/settings" title='Admin setting'>
